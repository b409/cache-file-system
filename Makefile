...
posix_for_s3_test : posix_for_s3_test.o posix_for_s3.o io_queue.o tt_func.o sn_sckt.o xml_msg.o utility.o
	gcc posix_for_s3_test.o posix_for_s3.o io_queue.o tt_func.o sn_sckt.o xml_msg.o utility.o $(CC_OP) posix_for_s3_test $(LINK_LIB)
